<?php
include 'config/prevent_login_users.php'
?>
...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Register Creative</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                    ...
                    <div class="row flex-1 g-0">
                        <div class="col-lg-6 h-100 my-auto">
                            ...
                            <div class="creative-card-body card-body p-sm-5">
                                ...
                                <form  action="assets/php/form-helper/register.php" method="post" class="w-100 mt-4 pt-2">
                                    <div class="mb-4">
