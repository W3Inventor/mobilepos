...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Sales Reports</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                            ...
                            <div class="card stretch stretch-full">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="fw-bold d-block text-black">
                                            <span class="d-block">Today Sales</span>
                                            <span class="fs-20 fw-bold d-block">LKR 10,000.00</span>
                                        </div>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card stretch stretch-full">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="fw-bold d-block text-black">
                                            <span class="d-block">Today Profit</span>
                                            <span class="fs-20 fw-bold d-block">LKR 5,000.00</span>
                                        </div>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card stretch stretch-full">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="fw-bold d-block text-black">
                                            <span class="d-block">Tolale Sales</span>
                                            <span class="fs-20 fw-bold d-block">24</span>
                                    </div>
                                        <div class="badge bg-soft-success text-success">
                                            <i class="feather-arrow-up fs-10 me-1"></i>
                                            <span>25.44%</span>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card stretch stretch-full">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="fw-bold d-block text-black">
                                            <span class="d-block">Yesterday Profit</span>
                                            <span class="fs-20 fw-bold d-block">LKR 1,400.00</span>
                                        </div>
                                        <div class="badge bg-soft-danger text-danger">
                                            <i class="feather-arrow-down fs-10 me-1"></i>
                                            <span>12.68%</span>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#paymentList').DataTable({
                ajax: 'assets/php/table-helper/get_sales_reports.php',
                columns: [
                    { data: 'invoice_no' },
                    { data: 'customer' },
                    {
                        data: 'amount',
                        render: data => 'LKR ' + data
                    },
                    { data: 'date' },
                    { data: 'method' },
                    {
                        ...
                        render: () => `
                            <div class="hstack gap-2 justify-content-end">
                                <a href="javascript:void(0);" class="avatar-text avatar-md"><i class="feather feather-eye"></i></a>
                                <div class="dropdown">
                                    <a href="#" class="avatar-text avatar-md" data-bs-toggle="dropdown"><i class="feather feather-more-horizontal"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#"><i class="feather feather-printer me-3"></i><span>Print</span></a></li>
                                    </ul>
                                </div>
                            </div>`
                    }
