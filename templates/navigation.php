        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item nxl-hasmenu">
                                ...
                                <!-- <span class="nxl-micon"><i class="feather-smartphone"></i></span> -->
                                    <span class="nxl-mtext">Mobiles</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                                </a>
                                <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item nxl-hasmenu">
                                <a href="javascript:void(0);" class="nxl-link">
                                <!-- <span class="nxl-micon"><i class="feather-smartphone"></i></span> -->
                                    <span class="nxl-mtext">Accessories</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                                </a>
                                <ul class="nxl-submenu">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <i class="feather-shopping-cart fs-4 text-dark"></i>
                        <h6 class="mt-4 text-dark fw-bolder">Point Of Sales</h6>
                        <p class="fs-11 my-3 text-dark">Exxplan is a production ready POS to get started up and running easily.</p>
                        <a href="pos.php" class="btn btn-primary text-dark w-100">Payment</a>
                    </div>
                </div>
            </div>
        </div>
